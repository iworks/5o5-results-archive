...
if ( ! function_exists( 'int505_archive_offer_expire_on' ) ) :
	function int505_archive_offer_expire_on( $post_ID = null ) {
		if ( empty( $post_ID ) ) {
			$post_ID = get_the_ID();
		}
		if ( in_array( get_post_status( $post_ID ), [ 'publish', 'preview' ] ) ) {
			...
			$date        = strtotime( $date );
			$time_string = '<time class="entry-date expires" datetime="%s">%s</time>';
			$time_string = sprintf(
				$time_string,
				esc_attr( wp_date( DATE_W3C, $date ) ),
			...
			the_job_status( $post_ID );
		}
	}
endif;

if ( ! function_exists( 'int505_archive_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function int505_archive_posted_on( $link = true ) {
...
if ( ! function_exists( 'int505_archive_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'int505_archive_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function int505_archive_entry_footer() {
...
if ( ! function_exists( 'int505_archive_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function int505_archive_post_thumbnail() {
